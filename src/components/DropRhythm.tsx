  ...
  return (
    <div className="space-y-7">
      ...
      <div>
        ...
        <p className="t-small mt-1 text-ink-2">
          The day this drop ends and the next board opens. The finished one
          goes to Drop History, where it stays available to look at or re-open.
          Your research board carries across to the new drop. Research always
          runs a week ahead of whichever day you pick.
        </p>
        <div className="mt-3 flex flex-wrap gap-2">
          {DAYS.map((d) => (
            <button
